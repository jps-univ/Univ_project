...
<body>
    ...
    <div class="content">
        <!-- 로고 -->
        <div class="logo" style="margin-bottom: 0px; margin-left: 200px">
            <div style="display: inline-block; position: relative; bottom:15px">
                <img src="${pageContext.request.contextPath}/resources/img/jpsLogo2.png" alt="학교로고0" width="100"
                     height="100"></div>
                ...
                <div class="login-wrapper">
                    <span>
                        <div class="userId">
                            ...
                            <input class="userID" maxlength="10" name="stdId" required="required" id="userID"
                                   type="text" onblur="changeLable(this)">
                ...
                <div class="login-wrapper">
                    <span>
                        <div class="userPwd">
                            ...
                            <input class="userPWD" maxlength="10" name="stdPwd" required="required" id="userPWD"
                                   type="password" onblur="changeLable(this)">
                            <i class="fas fa-lock"></i>
                        </div>
                    </span>
                </div>
                <div class="findArea">
                    <button type="button" id="findTdBtn" class="btn-default" data-toggle="modal" data-target="#myModal">
                        아이디찾기
                    </button>
                    <button type="button" id="findTdPwdBtn" class="btn-default" data-toggle="modal"
                        ...
                        <div id="findIdInfoArea">
                            ...
                            <span>
                                <div class="userId">
                                    ...
                                    <input maxlength="10" class="userID" required="required" id="stdName" type="text"
                                           onblur="changeLable(this)" style="border:none">
                                </div>
                            </span>
                            </div>
                            <div class="login-wrapper">
                            <span>
                                <div class="userPwd">
                                    <label for="stdEmail"
                                           style="left: 0px; right: auto; position: absolute;">이메일</label>
                                    <input class="userPWD" required="required" id="stdEmail" type="text"
                                           onblur="changeLable(this)" style="border:none">
                                </div>
                            </span>
                            </div>
                        ...
                        <div id="findPwdInfoArea">
                            <div class="login-wrapper">
                                <span>
                                    <div class="userId">
                                        <label for="userID"
                                               style="left: 0px; right: auto; position: absolute;">아이디</label>
                                        <input class="userID" required="required" id="pwdfindID" type="text"
                                               onblur="changeLable(this)" style="border:none;">
                                    </div>
                                </span>
                            </div>
                            <div class="login-wrapper">
                                <span>
                                    <div class="userPwd">
                                        <label for="userPWD"
                                               style="left: 0px; right: auto; position: absolute;">성명</label>
                                        <input class="userID" maxlength="10" required="required" id="pwdfindName"
                                               type="text" onblur="changeLable(this)" style="border:none;">
                                    </div>
                                </span>
                            </div>
                            <div class="login-wrapper">
                                <span>
                                    <div class="userPwd" style="margin-bottom: 0;">
                                        <label for="userPWD"
                                               style="left: 0px; right: auto; position: absolute;">이메일</label>
                                        <input class="userID" required="required" id="pwdfindEmail" type="text"
                                               onblur="changeLable(this)" style="border:none;">
                                    </div>
