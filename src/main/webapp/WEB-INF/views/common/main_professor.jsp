...
<body id="page-top">
                        ...
                        <div class="notice_nav_area">
                            ...
                            <ul class="nav nav-tabs">
                               <!--  <li class="active"><a data-toggle="tab" href="#qaa" id="qnaBtn" data-mode="Q">Q&A</a></li> -->
                                <li class="active"><a data-toggle="tab" href="#faq" id="faqBtn">FAQ</a></li>
                                <li><a data-toggle="tab" href="#notice" id="noticeBtn" data-mode="N">진포공지</a></li>
                            </ul>
                        </div>
                        <div class="tab-content">
                            <!-- Q&A -->
                            <div id="qaa" class="tab-pane fade in">
                                <ul>
                            ...
                            <!-- FAQ -->
                            <div id="faq" class="tab-pane fade active">
                                <div class="container">
    ...
    <script src="${contextPath}/resources/js/main_page_professor.js"></script>
