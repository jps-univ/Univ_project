				...
				<div id="main_con">
							...
							<table id="title_secret">
								<tbody>
									<tr>
										...
										<td><input type="text" size="135" name="search"></td>
									</tr>
									<tr>
										<td><label class="write_subject">비밀글</label></td>
										<td><input type="checkbox" name="secret_mode"
											id="secret_mode" value="unseen"></td>
									</tr>
									<tr>
										<td><label class="write_subject2">내용</label></td>
										<td><textarea id="summernote"><p>Hello Summernote</p></textarea></td>
									</tr>
									<tr>
					...
					<div id="button_div">
						<table>
							<tr>
								<td></td>
								<td><button id="board_button1">제출</button></td>
